            ...
            carousel = {
                init: function () {
                    ...
                    $slidewrap.each(function (carInt) {
                        ...
                        $slider.attr('id', ($slider[0].id || 'carousel-' + inst + '-' + carInt))
                            .css({
                            "marginLeft": "0px",
                            "float": "left",
                            "width": 100 * slidenum + "%",
                ...
                navState: function (e, ui) {
                    ...
                    $activeSlide.addClass(opt.namespace + "-active-slide")
        ...
        $el.bind("snapback", snapBack)
            ...
            $el.bind("gesturestart", function (e) {
                ...
                if (start && stop) {
                    ...
                    if (Math.abs(start.coords[0] - stop.coords[0]) > 10 && Math.abs(start.coords[0] - stop.coords[0]) > Math.abs(start.coords[1] - stop.coords[1])) {
                        e.preventDefault();
                    } else {
                        $el.trigger('snapback', {
                            target: $tEl,
